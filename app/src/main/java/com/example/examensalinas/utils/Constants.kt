...
object Constants {
    ...
    const val END_POINT_MOVIE_POPULAR = "movie/popular?api_key="
    const val END_POINT_MOVIE_NOW = "movie/now_playing?api_key="
    const val API_KEY = "29d6b5941ac2445b2734215b41fab36f"
    const val QUERY_OPTIONAL = "&language=en-US&page=1"
